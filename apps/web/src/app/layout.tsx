...
export const metadata: Metadata = { title: 'Novel Library', description: 'Your private Chinese novel library and translation workspace' };
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" suppressHydrationWarning>
    ...
    <body><AppNavigation/><div className="app-shell">{children}</div></body>
  </html>;
}
